...
- `isFloat32Array`: 是不是一个 `Float32Array`，每一项占四个字节，值为 `-3.4e38 - 3.4e38`，并且 `1.2e-38` 是最小的正数
- `isFloat64Array`: 是不是一个 `Float64Array`，每一项占八个字节，值为 `-1.8e308 - 1.8e308`，并且 `5e-324` 是最小的正数
